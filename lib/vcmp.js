(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("vcmp", ["vue"], factory);
	else if(typeof exports === 'object')
		exports["vcmp"] = factory(require("vue"));
	else
		root["vcmp"] = factory(root["Vue"]);
...
var root = ___WEBPACK_IMPORTED_MODULE_0__[/* isServer */ "e"] ? global : window;
/* istanbul ignore next */
...
function scroll_getElementTop(el) {
  if (isWindow(el)) {
    return 0;
  }
...
function isAndroid() {
  /* istanbul ignore next */
  return utils["e" /* isServer */] ? false : /android/.test(navigator.userAgent.toLowerCase());
}
function isIOS() {
  /* istanbul ignore next */
  return utils["e" /* isServer */] ? false : /ios|iphone|ipad|ipod/.test(navigator.userAgent.toLowerCase());
}
...
function toast_Toast(options) {
  ...
  options.clear = function () {
    ...
    if (toast_multiple && !utils["e" /* isServer */]) {
...
function NavBar(h, props, slots, ctx) {
  ...
  return h("div", helper_default()([{
    ...
    "on": {
      "click": ctx.listeners['click-left'] || utils["f" /* noop */]
    }
  }, [LeftPart()]), h("div", {
    ...
    "on": {
      "click": ctx.listeners['click-right'] || utils["f" /* noop */]
    }
  }, [RightPart()])]);
}
